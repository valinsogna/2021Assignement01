...
for line in lines:
    if(line[0]!='#'):
        ...
        if mess_size in d:
            ...
            d[mess_size]={'mess_size':str(v[0]),'rep':d_tmp['rep'],'lat':d_tmp['lat']*0.10,'max_lat':d_tmp['lat'],'min_lat':d_tmp['lat'],'speed':d_tmp['speed']*0.10,'min_speed':d_tmp['speed'],'max_speed':d_tmp['speed']}
