...
```{r, echo=FALSE, warning=FALSE, message = FALSE, out.width="40%", fig.cap="PingPing Pattern from Intel® MPI Benchmarks User Guide and Ring with P=3.",fig.align='center',fig.show='hold'}
library(magick)
...
![PingPong Pattern from Intel® MPI Benchmarks User Guide.](./img/pingpong.png){#id2 .class width=50% height=35% align=center}
